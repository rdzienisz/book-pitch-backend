...
public class UserController {
    ...
    @DeleteMapping("/bookings/{bookingId}/{pitchId}")
    public ResponseEntity<Void> deleteBooking(@PathVariable Long bookingId, @PathVariable Long pitchId) {
        bookingService.cancelBooking(bookingId, pitchId);
